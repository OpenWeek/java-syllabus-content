...
Aux USA, on peut boire de l'alcool légalement à partir de 21 ans.  La condition du code suivant pour que la variable booléenne **majeur** soit mise à la valeur **true**
uniquement si la variable int **age** est plus grande ou égale à 21, et **false** dans le cas contraire.
